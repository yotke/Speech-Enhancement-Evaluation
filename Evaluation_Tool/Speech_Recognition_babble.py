...
def main_speech_recognition():
    ...
    noisy_output_file = path.join(path.dirname(pwd+'/tmp/babble/noised_signal/'), input)
    DTLN_processed_output_file = path.join(path.dirname(pwd+'/tmp/babble/processed_noised_signal/'), input)
